...
\begin{tabular}{|l|l|c|}
\hline
\textbf{Thành viên} & \textbf{Nhiệm vụ chính} & \textbf{Hoàn thành} \\ \hline
\textbf{Phạm Phú Hòa} (Nhóm trưởng) & Review toàn bộ code/notebook; debug; viết báo cáo PDF; tích hợp kết quả & 100\% \\ \hline
\textbf{Nguyễn Lâm Phú Quý}          & Phần 2: EDA bảng; phân phối \& tương quan; imputation (7 chiến lược); outlier detection & 100\% \\ \hline
\textbf{Huỳnh Trung Kiệt}             & Phần 2: Scaling (5 pp); encoding (5 pp, VIF); feature selection (3 tầng); class imbalance & 100\% \\ \hline
\textbf{Trần Chí Nguyên}              & Phần 1: EDA ảnh; preprocessing pipeline (resize/colorspace/norm/aug); PCA; edge detection & 100\% \\ \hline
\textbf{Đào Sỹ Duy Minh}              & Phần 3: Text EDA (Zipf, TTR); pipeline 9 bước; tokenization; stemming; BoW/TF-IDF/W2V/ST & 100\% \\ \hline
\end{tabular}%
}
