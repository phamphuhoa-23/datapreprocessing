...
\begin{itemize}
    ...
    \item Tỉ lệ mất cân bằng lớp cao: fraud $\approx 3{,}5\%$ (ratio $\approx 27{,}6:1$).
...
\caption{RFE với Logistic Regression (5-fold CV) tại $k \in \{5, 10, 20, 30, 50\}$ đặc trưng. \textbf{Best: $k=30$} (F1=0{,}761, highlight đỏ) -- F1 tăng từ 5 đến 30 rồi giảm nhẹ tại 50, xác nhận 30 đặc trưng là điểm tối ưu.}
\label{fig:rfe_curve}
\end{figure}
